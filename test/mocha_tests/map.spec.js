...
describe('Map ', () => {
          ...
          "categories":[
             {
                ...
                "indicators":[
                   ...
                   },
                   {
                      ...
                      "score":4,
                      "supportingText":"sdfl",
                      "scoreDescription":"Digital health is being implemented as part of national health or other relevant national strategies and/or plans."
                   }
                ]
             },
          ],
 ...
 let healthIndicatorData = [
  ...
  it(" should set the window properties when the filter method is called and fetch the fetchGlobalIndices", (done) => {
    ...
    moxios.wait(() => {
      expect(wrapper.vm.globalHealthIndicators).to.deep.equal(globalData.countryHealthScores);
      worldMap.drawMap.restore();
      done();
    });
  });
