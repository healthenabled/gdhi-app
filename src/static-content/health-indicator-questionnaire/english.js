export const healthIndicatorQuestionnaire = {
  ...
  contactForm: {
    ...
    error: {
      ...
      roleOfThePersonEnteringData: 'Role of the person entering the data is required',
    ...
    hoverText: {
      ...
      nameOfPersonEnteringData: 'Please enter the name of the person entering this data',
      roleOfThePersonEnteringData: 'Please enter the role of the person entering the data',
      email: 'Enter email',
      nameOfTheApprover: 'Please enter the name of the person approving the data',
      roleOfTheApprover: 'Please enter the role of the person approving the data',
      nameOfTheCountryContact: 'Country contact',
      roleOfTheCountryContact: 'Role of the country contact',
      organisationOfTheCountryContact: 'Enter Organisation of the country contact',
    }
  },
  resourceForm: {
