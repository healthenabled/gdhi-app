export const healthIndicatorQuestionnaire = {
  ...
  contactForm: {
    ...
    error: {
      ...
      nameOfPersonEnteringData: 'Le nom de la personne qui saisit les données est requis',
      roleOfThePersonEnteringData: 'Le rôle de la personne qui saisit les données est requis',
      email: 'Veuillez entrer un email valide',
      nameOfTheApprover: 'Le nom de la personne qui approuve les données est requis',
      roleOfTheApprover: 'Le rôle de la personne qui approuve les données est nécessaire',
      nameOfTheCountryContact: 'Un contact dans le pays est requis',
      roleOfTheCountryContact: 'Rôle de la personne-ressource dans le pays est nécessaire',
      countrySummary: 'Un résumé du pays est requis',
      organisationOfTheCountryContact: 'Veuillez entrer le nom de l\'organisation',
    },
    hoverText: {
      date: 'Veuillez entrer une date',
      nameOfPersonEnteringData: 'Veuillez entrer le nom de la personne qui saisit les données',
      roleOfThePersonEnteringData: 'Veuillez entrer le rôle de la personne qui saisit les données',
      email: 'Ingresar correo electrónico',
      nameOfTheApprover: 'Veuillez entrer le nom de la personne qui approuve les données',
      roleOfTheApprover: 'Entrar a função da pessoa que aprova esses dados',
      nameOfTheCountryContact: 'Contact dans le pays',
      roleOfTheCountryContact: 'Rôle de la personne-ressource dans le pays',
      organisationOfTheCountryContact: 'Entrer organisation du pays contact',
    },
  },
  resourceForm: {
